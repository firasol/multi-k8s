...
docker push fabughazaleh/mulit-client:latest
docker push fabughazaleh/mulit-server:latest
docker push fabughazaleh/mulit-worker:latest
docker push fabughazaleh/mulit-client:$SHA
docker push fabughazaleh/mulit-server:$SHA
docker push fabughazaleh/mulit-worker:$SHA
kubectl apply -f k8s
